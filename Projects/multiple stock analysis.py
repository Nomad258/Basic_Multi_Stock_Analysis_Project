...
for ticker in tickers:
    try:
        ...
        charts = {
            f"{ticker}_stock_price_moving_avg.png": stock_data[[price_column, "50-Day MA", "200-Day MA"]],
            f"{ticker}_daily_returns_histogram.png": stock_data["Daily Return"],
            f"{ticker}_rolling_volatility.png": stock_data["Volatility"]
        }
        ...
        chart_images = [f"{ticker}_stock_price_moving_avg.png", f"{ticker}_daily_returns_histogram.png", f"{ticker}_rolling_volatility.png"]
        ...
        print(f"Excel file '{excel_filename}' successfully updated with graphs and formatted analysis for {ticker}!")
